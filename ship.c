...
static blah_bool bullet_destroy(Blah_Entity *bullet, Blah_Entity_Event *dest_event);
...
Blah_Entity *bullet_new(Blah_Entity *ship) {
	...
	Blah_Primitive *bullet_prim1 = Blah_Primitive_new(BLAH_PRIMITIVE_TRIANLGE_STRIP, bullet_top);
	Blah_Primitive_mapTextureAuto(bullet_prim1, bullet_texture);
	Blah_Primitive *bullet_prim2 = Blah_Primitive_new(BLAH_PRIMITIVE_TRIANLGE_STRIP, bullet_bottom);
	...
	Blah_Entity_setActiveCollision(new_bullet,BLAH_TRUE);
...
static blah_bool bullet_destroy(Blah_Entity *bullet, Blah_Entity_Event *dest_event) {
	...
	return BLAH_FALSE; //Return false means the entity is destroyed and don't continue
}
